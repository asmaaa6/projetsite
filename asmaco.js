...
// Désactiver tous les effets de zoom sur les images du diaporama
document.querySelectorAll('.imageslide img').forEach(img => {
    img.style.transform = 'none';  // Désactive toute transformation
    img.style.transition = 'none'; // Désactive la transition
    img.style.cursor = 'default';  // Optionnel : Empêche l'effet de survol
});
